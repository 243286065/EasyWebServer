...
static const struct option long_options[] = {
		...
		{ "conf", required_argument, NULL, 'c' }, { "port", required_argument,
				NULL, 'p' }, { "log", required_argument, NULL, 'l' }, { "dir",
				required_argument, NULL, 'd' }, { "tthreadnum",
				required_argument, NULL, 't' }, { "maxconnect",
				required_argument, NULL, 'w' }, { NULL, 0, NULL, 0 } };
