...
void send_respond_head_common(int code,std::string& content_type,int keeplive,int fd);
...
public:
	...
	int keep_alive;
	ew_http_respond_class(std::string& filename_s);
...
public:
	...
	int keepalive;	//mark
	size_t value_IF_MODIFILE_SINCE;
